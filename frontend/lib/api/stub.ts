...
// Full 66-char hash. Backend always sends full hashes; the frontend
...
export function createStubClient(): ApiClient {
 ...
 // get the same reconcile path the live client provides. The stub
 // never reports a disconnected/rejected send.
