// Mock VaultSnapshot mirroring the FE seed values from DATA_INVENTORY.md §2.
// Allocation/pool numbers match page.tsx exactly so the FE looks identical
// when IS_DEV_STUB flips off.

import type { VaultSnapshot, VaultTick } from "../types";

const VAULT_ADDRESS = "0xA1b2C3d4E5F6789012345678901234567890ABcd"; // placeholder; B3 swaps in the real Base mainnet vault
...
// Mutate the live scalars and return a partial tick. Random walk only; series
// arrays don't move in B1.
